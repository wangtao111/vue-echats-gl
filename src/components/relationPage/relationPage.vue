...
<script>
    export default {
        ...
        mounted() {
            this.printRelationMap();
            this.printTimeline();
        },
        methods: {
            printRelationMap() {
                var myChart = echarts.init(document.getElementById('relation_map'));
                var option = {
                    title: {text: '军事关系', textStyle: {color: '#fff'}},
                    tooltip: {
                            ...
                            data: [
                                {
                                    name: '中国',
                                    des: '描述文字<br/>具体内容<br/>',
                                    symbol: 'image://./src/image/house.png',
                                    symbolSize: 50,
                                    itemStyle: {
                                        normal: {}
                                    }
                                    ...
                                    name: '军事基地1',
                                    des: '描述文字<br/>具体内容<br/>',
                                    symbol: 'image://./src/image/radar.png',
                                    symbolSize: 50,
                                }, {
                                    name: '军事基地2',
                                    symbol: 'image://./src/image/house.png',
                                    ...
                                    name: '人物2',
                                    symbol: 'image://./src/image/man.png',
                                    des: '汉东省省委副书记兼政法委书记。年近六十，是一个擅长太极功夫的官场老手。侯亮平、陈海和祁同伟是其学生。',
                                    symbolSize: 50
                                }, {
                                    name: '人物3',
